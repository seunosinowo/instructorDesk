    ...
    >
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg text-gray-dark max-w-3xl mx-auto mb-8">
          Teacherrs is a platform designed to bridge the gap between students and teachers. Our mission is to provide a space where knowledge is shared, skills are honed, and communities are built. Join us today to explore a world of learning opportunities!
        </p>
        <motion.div
