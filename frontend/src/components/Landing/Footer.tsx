  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-6">
              ...
              <span className="text-2xl font-bold">eacherrs</span>
            </div>
            <p className="text-gray-400 mb-6">
              The professional network dedicated to transforming education through meaningful connections.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 mt-1 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                <span>info@teacherrs.com</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 mt-1 text-orange-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                <div>
                  <div>2nd Floor, Tapa House,</div>
                  <div>3/5 Imam Dauda Street, off Eric Moore Rd,</div>
                  <div>Surulere, Lagos 101271, Nigeria</div>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Teechha. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
